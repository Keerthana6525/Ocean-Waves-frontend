...
const AboutUs = () => {
  ...
  return (
    <Box sx={{ pt: { xs: 14, md: 16 }, pb: {xs:5,md:10}, px: 2 ,bgcolor: "#f9fcfaff"}}>
      <Container>
        <CustomBox>
          <ImgContainer>
          ...
          <Box>
            <Typography sx={{ fontSize: '35px', fontFamily:'"Hind Vadodara",sans-serif',color: 'black', fontWeight: '700', my: 3 }}>
              ABOUT OUR COMPANY
            </Typography>

            <Typography sx={{ fontSize: '18px',fontFamily:'"Hind Vadodara",sans-serif', color: 'black', lineHeight: '27px' }}>
